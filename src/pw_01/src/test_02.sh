...
printFormat "* === Run Extended Integer Arithmetic Expression Calculator Checks === *" $BLUE $BOLD
printFormat "************************************************************************" $BLUE $BOLD
